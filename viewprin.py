...
class Carros(Tk):
    def __init__(self):
        ...
        self.font = ('Impact', '24', 'bold')
        self.font2 = ('Verdana','10','bold')

        self['bg'] = 'gray14'
        self.geometry('400x400+750+100')
        self.title('Concessionária DEFENSOR')

        self.bt1 = Button(self, width=11, height=5, text="Bmw X5", bg = 'gold',borderwidth=5,font = self.font2, command=Bmw)
        self.bt2 = Button(self, width=11, height=5, text="New Civic", bg = 'gold',borderwidth=5, font = self.font2, command=Civic)
        self.bt3 = Button(self, width=11, height=5, text="Audi A7", bg='gold',borderwidth=5, font = self.font2, command=Audi)
        self.bt4 = Button(self, width=11, height=5, text="Camaro", bg='gold', borderwidth=5, font = self.font2, command=Camaro)
        self.bt5 = Button(self, width=11, height=5, text="Mustang", bg='gold',borderwidth=5, font = self.font2, command=Mustang)
        self.bt6 = Button(self, width=11, height=5, text="Porsche", bg='gold',borderwidth=5,  font=self.font2, command=Porsche)

        self.lb = Label(self ,text='PÁTIO',bg='gray14',fg='gold' ,font = self.font)
        self.lb.place(x=150, y=15)
...
class Bmw(Toplevel):
    def __init__(self):
        ...
        self.lb = Label(self, text='DADOS FINAIS!', bg='gray14', fg='gold', font=self.font)
        self.lb.place(x=100, y=30)
        self.lb2 = Label(self, text='Nome do vendedor:', bg='gray14', fg='gold', font=self.font2)
        self.lb2.place(x=7, y=100)
        self.lb3 = Label(self, text='Nome do Cliente:', bg='gray14', fg='gold', font=self.font2)
        self.lb3.place(x=7, y=130)
        self.lb4 = Label(self, text='Data da compra:', bg='gray14', fg='gold', font=self.font2)
        self.lb4.place(x=7, y=300)
        self.valor = Label(self, text='VALOR DE VENDA:',bg='gray14',fg='gold',font=self.font)
        ...
        # botao confirm
        self.bt = Button(self, width=10, height=3, bg='white', text='Continuar', command = self.bmwaba)
 ...
 #-------------------
    def bmwaba(self):
        ...
        self.lb3 = Label(self, text='Comprador:', bg='gray14', fg='white', font=self.font3)
        self.lb3.place(x=18, y=150)
        self.lb4 = Label(self, text='Vendedor:', bg='gray14', fg='white', font=self.font3)
        self.lb4.place(x=18, y=190)
        self.lb5 = Label(self, text='Data de compra:', bg='gray14', fg='white', font=self.font3)
...
class Civic(Toplevel):
    def __init__(self):
        ...
        self.ed4.place(x=225, y=200)
        # botao confirm
        self.bt = Button(self, width=10, height=3, bg='white', text='Continuar', command=self.civicaba)
        self.bt.place(x=300, y=320)
...
class Audi(Toplevel):
    def __init__(self):
        ...
        self.ed4.place(x=225, y=200)
        # botao confirm
        self.bt = Button(self, width=10, height=3, bg='white', text='Continuar', command=self.audiaba)
        self.bt.place(x=300, y=320)
...
class Camaro(Toplevel):
    def __init__(self):
        ...
        self.ed4.place(x=225, y=200)
        # botao confirm
        self.bt = Button(self, width=10, height=3, bg='white', text='Continuar', command=self.camaroaba)
        self.bt.place(x=300, y=320)
...
class Mustang(Toplevel):
    def __init__(self):
        ...
        self.ed4.place(x=225, y=200)
        # botao confirm
        self.bt = Button(self, width=10, height=3, bg='white', text='Continuar', command=self.mustangaba)
        self.bt.place(x=300, y=320)
...
# entrys
        ...
        self.ed4.place(x=225, y=200)
        # botao confirm
        self.bt = Button(self, width=10, height=3, bg='white', text='Continuar', command=self.porscheaba)
        self.bt.place(x=300, y=320)
